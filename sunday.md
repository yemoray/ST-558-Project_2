...
|:-----|----:|----------------------:|------------------:|---------------:|--------------:|
| 2011 |  35 |                  2122 |              1042 |          12.24 |         64.27 |
| 2012 |  38 |                  3357 |              1415 |          12.88 |         60.82 |
...
| Year |   n | avg\_registered\_user | avg\_casual\_user | avg\_windspeed | avg\_humidity |
|:-----|----:|----------------------:|------------------:|---------------:|--------------:|
| 2011 |  35 |                   906 |               698 |          5.033 |        14.395 |
| 2012 |  38 |                  1097 |               903 |          5.138 |        14.418 |
...
|:------------------------------|-------:|-------:|-------:|-----:|
| Low number of casual users    |     19 |      2 |      0 |   13 |
| Medium number of casual users |      0 |     10 |      8 |    3 |
| High number of casual users   |      0 |      9 |      6 |    3 |
...
|                                   | Winter | Spring | Summer | Fall |
|:----------------------------------|-------:|-------:|-------:|-----:|
| Low number of registered users    |     13 |      4 |      0 |    0 |
| Medium number of registered users |      6 |     12 |     10 |   16 |
| High number of registered users   |      0 |      5 |      4 |    3 |
...
```
    ...
    ## t = 0.53015, df = 142.35, p-value = 0.5968
    ## alternative hypothesis: true difference in means is not equal to 0
    ## 95 percent confidence interval:
    ##  -0.04307234  0.07464255
    ## sample estimates:
    ## mean of x mean of y 
    ## 0.4581978 0.4424127

The p-value is about 0.5968312, which is pretty large, so we don’t have
...
|-------:|-----:|--------:|-------:|--------:|-----:|
|      1 | 0.07 |    0.19 |   0.24 |    0.26 | 0.36 |
|      2 | 0.07 |    0.14 |   0.18 |    0.22 | 0.34 |
|      3 | 0.06 |    0.12 |   0.17 |    0.20 | 0.25 |
|      4 | 0.07 |    0.11 |   0.17 |    0.20 | 0.40 |
...
trees equal to 28 we get the minimum error rate 790.1876247, which may
...
|:--------------|--------:|
| Full Linear   | 1037.77 |
| Subset Linear |  711.76 |
| Random Forest | 1785.54 |
| Boosted Tree  |  901.02 |
