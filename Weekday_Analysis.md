...
|-------:|-----:|--------:|-------:|--------:|-----:|
|      1 | 0.08 |    0.17 |   0.23 |    0.26 | 0.42 |
|      2 | 0.12 |    0.17 |   0.21 |    0.28 | 0.39 |
|      3 | 0.09 |    0.14 |   0.16 |    0.21 | 0.30 |
|      4 | 0.05 |    0.08 |   0.12 |    0.18 | 0.36 |
...
trees equal to 449 we get the minimum error rate 923.0247056, which may
...
|:--------------|--------:|
| Full Linear   |  680.40 |
| Subset Linear |  906.52 |
| Random Forest | 1736.71 |
| Boosted Tree  |  598.01 |
...
Here, the winner belongs to the Boosted Tree model.
