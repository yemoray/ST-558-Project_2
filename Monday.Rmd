...
For a small data set, we want to try boosted tree regression in order to aviod the problem of overfitting. We want to use the method **Gradient Boosting Machines**, which has lots of flexcibility and can be provided several hyperparameter tuning options that make the function fit very flexible.
