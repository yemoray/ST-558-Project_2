...
ggplot(data=day_data_Train, aes(x=weather_situation, y= count))+
  ...
  labs(x="Weather Situation", y="Total number of rentals", fill="Weather Situation", title = "Boxplot of Total number of rentals by Weather situation for this week day")+
